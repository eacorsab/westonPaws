  ...
  return (
    <>
      ...
      <div className="w-full grid grid-cols-2">
        ...
        >
          <h1 className="text-yellow-500 text-4xl">Full GROMMING INCLUDES:</h1>
        ...
        <div className="bg-[#28123f] h-full justify-around px-4 py-4">
          <div className="py-2">
            ...
            <p className="text-white">
              For Full Gromming information, please contact us.
            </p>
          </div>
          <form onSubmit={handleSubmit}>
            <div className="grid grid-row-6 gap-4">
              ...
              <select
                ...
                onChange={handleChange}
              >
                <option value="option1">Partial Grooming</option>
                <option value="option2">Full Grooming</option>
